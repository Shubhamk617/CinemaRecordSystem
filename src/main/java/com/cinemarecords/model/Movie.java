...
public class Movie /* extends RepresentationModel<Movie> */ {
	...
	@JsonManagedReference(value = "movie-director")
	// @JoinTable(name = "movie_director", joinColumns = { @JoinColumn(name =
	...
	// @JsonBackReference(value = "movie-actors")
	private Set<Actor> actors;

	@ManyToOne(cascade = CascadeType.ALL)
	@JoinColumn(name = "cinematography_Id")
	// @JsonBackReference(value = "movie-cinematographies")
	...
	public Movie(
			...
			@PositiveOrZero double boxOfficeCollectionInCrores, Director director, Set<Actor> actors,
	...
	public Cinematography getCinematography() {
		return cinematography;
	}

	public void setCinematography(Cinematography cinematography) {
		this.cinematography = cinematography;
	}
